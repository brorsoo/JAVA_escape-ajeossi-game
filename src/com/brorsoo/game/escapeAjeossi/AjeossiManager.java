...
public class AjeossiManager {
    ...
    public void shortWord(Ajeossi ajeossi) {
        ...
        switch (num) {
            case 1:
                System.out.println("======= 줄임말 테스트 문제 ========");
                System.out.println("======= \'캘박\'의 뜻은? =======\n");
    ...
    public void girlGroup(Ajeossi ajeossi) {
        ...
        switch (num) {
            case 1:
                System.out.println("======= 최신 걸그룹 노래 맞추기 문제 ========");
                System.out.println("‘SuperShy’를 부른 그룹은? \n\n1. 소녀시대\n2. 뉴진스\n3. 엑소\n");
                System.out.print("번호선택 : ");
                inputNum = sc.nextInt();
                answer = 2;
            ...
            case 2:
                System.out.println("======= 최신 걸그룹 노래 맞추기 문제 ========");
                System.out.println("‘I AM’를 부른 그룹은? \n\n1. 에스파\n2. HOT\n3. 아이브\n");
                System.out.print("번호선택 : ");
                inputNum = sc.nextInt();
                answer = 3;
            ...
            case 3:
                System.out.println("======= 최신 걸그룹 노래 맞추기 문제 ========");
                System.out.println("‘Unforgiven’를 부른 그룹은? \n\n1. 르세라핌\n2. 원더걸스\n3. NCT\n");
                System.out.print("번호선택 : ");
                inputNum = sc.nextInt();
                answer = 1;
            ...
            case 4:
                System.out.println("======= 최신 걸그룹 노래 맞추기 문제 ========");
                System.out.println("‘퀸카’를 부른 그룹은? \n\n1. (여자)아이들\n2. (남자)아이들\n3. (혼성)아이들\n");
                System.out.print("번호선택 : ");
                inputNum = sc.nextInt();
                answer = 1;
            ...
            case 5:
                System.out.println("======= 최신 걸그룹 노래 맞추기 문제 ========");
                System.out.println("‘Feel my Rhythm’를 부른 그룹은? \n\n1. 레드린넨\n2. 레드코튼\n3. 레드벨벳\n");
                System.out.print("번호선택 : ");
                inputNum = sc.nextInt();
                answer = 3;
            ...
            case 6:
                System.out.println("======= 최신 걸그룹 노래 맞추기 문제 ========");
                System.out.println("‘Teddy Bear’를 부른 그룹은? \n\n1. 스테이씨\n2. 허각\n3. 방탄소년단\n");
                System.out.print("번호선택 : ");
                inputNum = sc.nextInt();
                answer = 1;
    ...
    public void ending(Ajeossi ajeossi) {
        ...
        if ( result >= 100) {
            System.out.println("내가 MZ가 아니면 누가 MZ란 말임! 어디가서 아저씨라는 말 절대 안듣는다 진짜");
        } else if ( result >= 50) {
            System.out.println("MZ 아덜램이 있는 아부지 정도..?");
        } else {
            System.out.println("나랏말싸미 듕귁에 달아..... 조상님......");
        }
        System.out.println("===============================");
